...
public class Manipulacao {
    ...
    public static final String DB_ALUGUEL = "DIRETORIO_GERAL/ALUGUEL/ALUGUEL";
    ...
    public static void removerDadosArquivoFilme(File filme, String salvaDados) throws Exception {
        ...
        for (String line : lines) {
            ...
            if (verifica.equals(salvaDados)) {
                remove = line.split("\t")[0] + "\t" + line.split("\t")[1] + "\t" + line.split("\t")[2] + "\t" + line.split("\t")[3] + "\t"+ line.split("\t")[4] + "\n";
                break;
            }
        }

        for (String line : lines) {
            String verifica = line.split("\t")[0] + "\t" + line.split("\t")[1] + "\t" + line.split("\t")[2] + "\t" + line.split("\t")[3] + "\t"+ line.split("\t")[4] + "\n";
            if (verifica.equals(remove)) {
                continue;
            }

            aux += line.split("\t")[0] + "\t" + line.split("\t")[1] + "\t" + line.split("\t")[2] + "\t" + line.split("\t")[3] + "\t"+ line.split("\t")[4] + "\n";
        }
    ...
    public static void alterarDadosArquivoFilme(File clientes, String dadosAntigos, String dadosNovos) throws Exception {
        String[] lines = Manipulacao.lerArquivo(clientes).split("\n");
        String pula = "";
        String aux = "";
        ...
        for (String line : lines) {
            ...
            String verifica = nome + "\t" ;
            if (verifica.equals(dadosAntigos)) {
                pula = line.split("\t")[0] + "\t" + line.split("\t")[1] + "\t" + line.split("\t")[2] + "\t" + line.split("\t")[3] + "\t"+ line.split("\t")[4] + "\n";
                break;
            }
        }
