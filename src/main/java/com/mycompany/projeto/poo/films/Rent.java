...
public class Rent extends javax.swing.JFrame {
            ...
            if (aluguel.length() == 0) {
                ...
                for (String line : lines) {
                    ...
                    if (aux.equals(pesquisa)) {
                        ...
                        JOptionPane.showMessageDialog(rootPane, "Cliente possui dividas pendentes !");
                        break;
                    }
                }
    ...
    public static void alugueldefilme(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Rent.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
