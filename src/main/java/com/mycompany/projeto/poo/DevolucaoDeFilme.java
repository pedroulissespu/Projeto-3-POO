 ...
 * @author pedroupcm
 */
public class DevolucaoDeFilme extends javax.swing.JFrame {
    private boolean verificaPesquisa = false;

    public DevolucaoDeFilme() {
        initComponents();
    }
    ...
    private void botaoDevolverActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_botaoDevolverActionPerformed
        if (!verificaPesquisa) {
            ...
            if (diaDeLocacao - dia > 2) {
                ...
                precoFinal = Math.round(quantidadeFilmes * 1.20 * diasPagar + preco);
            } else {
                precoFinal = preco;
            }
    ...
    public static void devolucaodefilme(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DevolucaoDeFilme.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DevolucaoDeFilme().setVisible(true);
            }
        });
    }
