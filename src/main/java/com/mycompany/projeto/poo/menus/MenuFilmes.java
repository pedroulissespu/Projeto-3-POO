...
import com.mycompany.projeto.poo.filmes.AdicionarFilme;
import com.mycompany.projeto.poo.filmes.EditarFilmes;
import com.mycompany.projeto.poo.filmes.ListarFilmes;
import com.mycompany.projeto.poo.filmes.MostrarFilme;
import com.mycompany.projeto.poo.filmes.RemoverFilme;
...
public class MenuFilmes extends javax.swing.JFrame {
    ...
    private void listarFilmesActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_listarFilmesActionPerformed
        ...
        if (filmes.length() == 0) {
            ...
            ListarFilmes listarFilme = new ListarFilmes();
    ...
    private void botaoRemoverActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_botaoRemoverActionPerformed
        ...
        if (filmes.length() == 0) {
            ...
            RemoverFilme removeFilme = new RemoverFilme();
    ...
    private void botaoProcurarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_botaoProcurarActionPerformed
        ...
        if (filmes.length() == 0) {
            ...
            MostrarFilme mostraFilme = new MostrarFilme();
    ...
    private void botaoAlterarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_botaoAlterarActionPerformed
        ...
        if (filmes.length() == 0) {
            ...
            EditarFilmes editaFilme = new EditarFilmes();
    ...
    public void menufilmes(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuFilmes.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
