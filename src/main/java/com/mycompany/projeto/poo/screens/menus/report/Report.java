...
package com.mycompany.projeto.poo.screens.menus.report;

import com.mycompany.projeto.poo.customers.Historic;
import com.mycompany.projeto.poo.screens.ranking.films.Films;
...
public class Report extends javax.swing.JFrame {
    ...
    private void botaoHistoricoActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_botaoHistoricoActionPerformed
        Historic historicoCliente = new Historic();
    ...
    public static void menurelatorio(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Report.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
